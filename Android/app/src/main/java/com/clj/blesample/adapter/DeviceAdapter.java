...
public class DeviceAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            holder.btn_motion = (Button) convertView.findViewById(R.id.btn_motion);
        }
        ...
        holder.btn_motion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mListener != null) {
                    mListener.onMotion(bleDevice);
                }
            }
        });
    ...
    public interface OnDeviceClickListener {
        ...
        void onMotion(BleDevice bleDevice);
    }
