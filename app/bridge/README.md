...
Run the local commands from `app/bridge/`; source paths such as
`controller/include/cobs.h` are relative to the repository root.
...
```bash
cd 6DOF-Rotary-Stewart-Motion-Simulator/app/bridge
